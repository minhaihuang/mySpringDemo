...
public class Security {
	 ...
	 */
	@Pointcut(value="execution(* com.hhm.aopAnnotation_04_after.UserDaoImpl.add*(..))")
	private void pointCutAdd(){}
	
	@Pointcut(value="execution(* com.hhm.aopAnnotation_04_after.UserDaoImpl.delete*(..))")
	private void pointCutDelete(){}
	
	
	
	//测试最终通知，不管是否出现异常，都会执行
	@After(value="pointCutAdd()||pointCutDelete()")
