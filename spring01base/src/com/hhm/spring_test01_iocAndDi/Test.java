...
//		user.live();
		...
		//ApplicationContext context=new ClassPathXmlApplicationContext("com/hhm/spring_test01_iocAndDi/beans.xml");
		
		//第二种获取applicationContext对象的方法
		ApplicationContext context=new FileSystemXmlApplicationContext("G:\\workspace\\kuangjia\\spring01base\\src\\com\\hhm\\spring_test01_iocAndDi\\beans.xml");
