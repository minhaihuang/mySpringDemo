...
import org.springframework.context.FileSystemXmlApplicationContext;
...
//		user.live();
		...
		ApplicationContext context=new FileSystemXmlApplicationContext("G:/workspace/kuangjia/spring02MySpring/src/com/hhm/spring_02_di/beans.xml");
